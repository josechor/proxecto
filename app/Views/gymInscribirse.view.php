...
<div class="contenedor">
    ...
    ?>
        <div class="info">
            Disfruta de nuestra zona de gimnasio despues de rellenar nuestro formulario de pre-inscripcion
        </div>
        <form action="inscribirseGym" method="post">
            <h1> Datos </h1>
    ...
    ?>
        ...
        <form action="borrarInscribirseGym" method="post">
            <h1> Datos </h1>
