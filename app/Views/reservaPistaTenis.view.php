<link rel="stylesheet" href="assets/css/reservaPistaTenis.css">
<?php
    ...
    <table>
        ...
        ?>
            <tr class="<?php echo $op['color']?>">
                ...
                <td> <?php echo $op['reservar'] == true ? '<form method="post" action="reservarPistaTenis"><input name="fecha" type="text" hidden value="' . $op['fechaCompleta'] . '"/><input type="submit" class="botonReserva" value="Reservar"/></form>' : "" ?> </td>
            </tr>
        <?php
        }
        ?>
...
<script src="assets/js/cambiarDiaTenis.js"></script>
<!--  -->